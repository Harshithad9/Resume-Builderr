...
import { Resume, Education, Experience, Project, ValidationError } from '../types/resume'
import { validateResume as validateResumeUtil } from '../utils/validation'
...
const ResumeBuilder: React.FC = () => {
  ...
  const handleBasicInfoChange = (field: keyof Omit<Resume, 'education' | 'experience' | 'projects' | 'skills'>, value: string) => {
